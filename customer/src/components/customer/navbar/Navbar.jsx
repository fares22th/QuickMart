...
import { ShoppingCart, Heart, User, Search, MapPin, ChevronDown, Bell, Menu, X, Package } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="h-16 flex items-center gap-3">
          ...
          <div className="hidden md:flex items-center gap-1 shrink-0">
            <Link to="/notifications" className="relative p-2.5 rounded-xl hover:bg-gray-50 transition-colors group">
            ...
            {user && (
              ...
              >
                <Package
                  ...
                  style={{ color: activeOrdersCount > 0 ? '#00C896' : '#6B7280' }}
                />
                {activeOrdersCount > 0 && (
                  <>
                    {/* Pulsing ring */}
                    ...
                    {/* Badge */}
                    <span
                      className="absolute -top-0.5 -left-0.5 w-4 h-4 text-white text-[10px] font-extrabold rounded-full flex items-center justify-center"
                      style={{ background: '#00C896' }}
                    >
