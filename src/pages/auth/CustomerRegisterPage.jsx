...
export default function CustomerRegisterPage() {
  ...
  const onSubmit = async (data) => {
    await registerUser({ name: data.name, phone: data.phone, password: data.password, role: 'customer' })
    navigate('/verify-otp')
  }
          ...
          <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                <div className={wrap(errors.phone?.message)}>
                  ...
                  <input type="tel" placeholder="5xxxxxxxx" dir="ltr" className={inp} {...register('phone')} />
                </div>
